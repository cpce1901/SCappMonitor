...
from .views import  AlertsSelect, AlertInit, AlertsList, AlertsUpdate, AlertDeleteForm, AlertCreateForms, EmailList, EmailAdd, EmailDelete, EmailUpdate
...
urlpatterns = [
    ...
    path("alertas/gestion/<int:pk>/", AlertsList.as_view(), name="gestionAlertsSensor"),
